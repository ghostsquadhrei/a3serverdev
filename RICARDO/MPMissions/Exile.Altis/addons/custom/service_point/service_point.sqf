...
//====================== general settings
_folder = "addons\custom\service_point\"; // folder where the service point scripts are saved, relative to the mission file
...
_message = "Service de réparation & de réapprovisionnement"; // message to be shown when in range of a service point (set to "" to disable)
...
_repair_costs = [  //Need Money
		["Air",350],
		["Exile_Car_Offroad_Armed_Guerilla01",350],
		["Exile_Car_Offroad_Armed_Guerilla02",350],	
		["Exile_Car_Offroad_Armed_Guerilla03",350],	
		["Exile_Car_Offroad_Armed_Guerilla04",350],	
		["Exile_Car_Offroad_Armed_Guerilla05",350],	
		["Exile_Car_Offroad_Armed_Guerilla06",350],	
		["Exile_Car_Offroad_Armed_Guerilla07",350],	
		["Exile_Car_Offroad_Armed_Guerilla08",350],	
		["Exile_Car_Offroad_Armed_Guerilla09",350],	
		["Exile_Car_Offroad_Armed_Guerilla10",350],	
		["Exile_Car_Offroad_Armed_Guerilla11",350],	
		["Exile_Car_Offroad_Armed_Guerilla12",350],
        ["AllVehicles",350] 
];
        ...
        if (local _vehicle && _inVehicle) then {
                ...
                if (_inRange && (speed (_vehicle) < 1) && (speed (_vehicle) > -1)) then {
                        ...
                        if (SP_repair_action < 0 && _repair_enable) then {
                                ...
                                _actionTitle = [format["Réparer le %1",getText (configFile >> "Cfgvehicles" >> typeOf _vehicle >> "displayName")], _costs] call _fnc_actionTitle;
                        ...
                        if ((count SP_rearm_actions == 0) && _rearm_enable) then {
                                ...
                                _weapons = [_vehicle, _role] call _fnc_getWeapons;
                                {
                                        ...
                                        _ammo = [_vehicle,_curweapon] call _fnc_getAmmo;
                                        {
                                                ...
                                                _actionTitle = [format["Recharger %1 avec %2", _weaponName,_ammoname], _costs] call _fnc_actionTitle;
