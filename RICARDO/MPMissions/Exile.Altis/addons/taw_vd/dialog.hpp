...
class TAW_VD 
{
	...
	class controlsBackground {
		...
		*/
		class VDObjectSet : TAWVD_RscText //VDTerrSet
		{
			text = "Réglage des objets";
			y = 0.55;
		};
	...
	class controls 
	{
		...
		class VD_onfoot_slider : TAWVD_RscXSliderH 
		{
			...
			tooltip = "Distance de vue à pieds";
			x = 0.42;
			y = 0.30 - (1 / 25);
		...
		class VD_car_slider : TAWVD_RscXSliderH 
		{
			...
			tooltip = "Distance de vue dans un véhicule terrestre";
			x = 0.42;
			y = 0.35 - (1 / 25);
		...
		class VD_air_slider : TAWVD_RscXSliderH 
		{
			...
			tooltip = "Distance de vue dans un véhicule aérien";
			x = 0.42;
			y = 0.40 - (1 / 25);
		...
		class ObjectSyncCheckbox : TAWVD_Checkbox
		{
			idc = 2931;
			x = 0.32; y = 0.6;
			tooltip = "Sync rendu des objets avec rendu vue globale";
		...
		class VD_object_slider : VD_air_slider
		{
			...
			tooltip = "Distance de rendue des objets";
			y = 0.70 - (1 / 25);
		};
