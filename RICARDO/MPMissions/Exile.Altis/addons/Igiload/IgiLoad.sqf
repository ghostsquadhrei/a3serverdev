...
if (isnil "IL_Variables") then
{
	...
	IL_Para_Drop_ATL = 120;
	IL_Para_Jump_ATL = 30;
	//The minimum altitude for parachute opening
	IL_Para_Drop_Open_ATL = 100;
	IL_Para_Jump_Open_ATL = 100;
	...
	IL_Supported_Vehicles_HATCHBACK = 
	[
	...
	IL_Supported_Vehicles_HURON = ["Exile_Chopper_Huron_Black","Exile_Chopper_Huron_Green"];
	...
	IL_Supported_Vehicles_All = IL_Supported_Vehicles_STRIDER + IL_Supported_Vehicles_OFFROAD + IL_Supported_Vehicles_HATCHBACK + IL_Supported_Vehicles_VAN + IL_Supported_Vehicles_HEMTT + IL_Supported_Vehicles_KAMAZ + IL_Supported_Vehicles_TEMPEST + IL_Supported_Vehicles_MOHAWK + IL_Supported_Vehicles_MH9 + IL_Supported_Vehicles_HURON;
	...
	IL_Supported_Cargo_NonVeh_MH9 = IL_Supported_Box_H1 + IL_Supported_Box_H2;
	IL_Supported_Cargo_MH9 = IL_Supported_Supply_Crate + IL_Supported_Barrel + IL_Supported_Cargo_NonVeh_MH9; 
	
	IL_Supported_Cargo_NonVeh_Strider = IL_Supported_Box_H1 + IL_Supported_Box_H2;
	...
	IL_Supported_Cargo_NonVeh_Hatchback = IL_Supported_Box_H1 + IL_Supported_Box_H2;
	IL_Supported_Cargo_Hatchback = IL_Supported_Cargo_NonVeh_Hatchback;

	IL_Supported_Cargo_Veh_VAN = IL_Supported_Cargo_Veh_Offroad;
	IL_Supported_Cargo_NonVeh_VAN = IL_Supported_Box_H1 + IL_Supported_Box_H2;
	...
	IL_Supported_Cargo_Veh_HURON = IL_Supported_Quadbike + IL_Supported_Karts + IL_Supported_Rubberboat + IL_Supported_SDV + IL_Supported_Hatchback + IL_Supported_UGV;
	...
	IL_Supported_Cargo_All = IL_Supported_Bicycles + IL_Supported_Karts + IL_Supported_HEMTT + IL_Supported_KAMAZ + IL_Supported_TEMPEST + IL_Supported_STRIDER + IL_Supported_UGV + IL_Supported_VAN + IL_Supported_OFFROAD + IL_Supported_SUV + IL_Supported_Hatchback + IL_Supported_Quadbike + IL_Supported_Supply_Crate + IL_Supported_Veh_Ammo + IL_Supported_Rubberboat + IL_Supported_SDV + IL_Supported_Box_H1 + IL_Supported_Box_H2 + IL_Supported_Cargo20 + IL_Supported_TaruPods
};
...
if (isnil "IL_Procedures") then
{
	...
	IL_Init_Veh =
	{
		...
		if (_obj_type in IL_Supported_Vehicles_MH9) then
		{
			...
			if ((isNil {_obj getVariable "can_copilot"}) || (_force)) then {_obj setVariable["can_copilot", IL_Can_CoPilot, true];};
			if ((isNil {_obj getVariable "can_outside"}) || (_force)) then {_obj setVariable["can_outside", IL_Can_Outside, true];};
			if ((isNil {_obj getVariable "zload"}) || (_force)) then {_obj setVariable["zload", -1.04, true];};
		...
		if (_obj_type in IL_Supported_Vehicles_HATCHBACK) then
		{
			if ((isNil {_obj getVariable "box_num"}) || (_force)) then {_obj setVariable["box_num", 0, true];};
			if ((isNil {_obj getVariable "slots_num"}) || (_force)) then {_obj setVariable["slots_num", IL_Num_Slots_HATCHBACK, true];};
			if ((isNil {_obj getVariable "can_load"}) || (_force)) then {_obj setVariable["can_load", true, true];};
			if ((isNil {_obj getVariable "can_outside"}) || (_force)) then {_obj setVariable["can_outside", IL_Can_Outside, true];};
			if ((isNil {_obj getVariable "zload"}) || (_force)) then {_obj setVariable["zload", -0.65, true];};
			if ((isNil {_obj getVariable "load_offset"}) || (_force)) then {_obj setVariable["load_offset", 1.5, true];};
	...
	IL_Do_Load =
	{
		...
		if ((_obj_type in IL_Supported_Vehicles_HATCHBACK) && (_doors == "B")) then
		{
			_sdist = IL_SDistL;
			_spoint = _v modelToWorld [0,-5,-1.6];
			_box_num = _v getVariable "box_num";
			_slot_num = _v getVariable "slots_num";
		};
		...
		{
			_sdist = IL_SDistL;
			_spoint = _v modelToWorld [0,-7.5 - (_v getVariable "load_offset"),0];
			_box_num = _v getVariable "box_num";
			_slot_num = _v getVariable "slots_num";
		};
		...
		{
			_sdist = IL_SDistL;
			_spoint = _v modelToWorld [0,-7.2 - (_v getVariable "load_offset"),0];
			_box_num = _v getVariable "box_num";
			_slot_num = _v getVariable "slots_num";
		};
		...
		{
			{
                ...
                {					
					if (_lock2 <= 1) then
                    {
						...
						if ((_obj_type in IL_Supported_Vehicles_MOHAWK)  && (_doors == "B")) then
						{
							[_v, _x, [_x_cargo_offset,-7,-0.75 + _zload], [_x_cargo_offset,-5.5,-0.75 + _zload], 1, _turn] call IL_Move_Attach;
							[_v, _x, [_x_cargo_offset,-5.5,-0.75 + _zload], [_x_cargo_offset,-2.5,_zload], 1, _turn] call IL_Move_Attach;
							[_v, _x, [_x_cargo_offset,-2.5,_zload], [_x_cargo_offset,_counter + 9 - _cargo_offset,_zload], 1, _turn] call IL_Move_Attach;
						};
						if ((_obj_type in IL_Supported_Vehicles_MH9)  && (_doors == "L")) then
						{
                        ...
                        ["Success", format ["Le %1 est chargé!",_IL_noti]] call ExileClient_gui_notification_event_addNotification;
		...
		{
			{
				...
				if (_x getVariable "doors" == _doors) then
				{
					...
					if (((_x getVariable "attachedTruck") == _v) && ((_x getVariable "attachedPos") == (_counter)) && (_counter < 0) && !_done) then
					{
						...
						if ((_obj_type in IL_Supported_Vehicles_HURON)  && (_doors == "B")) then
						{
							...
							[_v, _x, [_x_cargo_offset,-4,_zload], [_x_cargo_offset,-4.5,-0.75 + _zload], 1, _turn] call IL_Move_Attach;
				...
				_IL_noti = getText(configFile >> "cfgVehicles" >> typeOf _x >> "displayName");
                ["Success", format ["Le %1 est dechargé!",_IL_noti]] call ExileClient_gui_notification_event_addNotification;
...
if (_obj_main_type in IL_Supported_Vehicles_MOHAWK) then
{
	...
	_obj_main addAction [
	"<img image='addons\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Charger cargaison</t>",
	{
	...
	_obj_main addAction [
	"<img image='addons\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Charger vehicule</t>",
	{
	...
	_obj_main addAction [
	"<img image='addons\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Decharger vehicule</t>",
	{
	...
	_obj_main addAction [
	"<img image='addons\IgiLoad\images\unload_para.paa' /><t color=""#b200ff"">  Parachute cargo</t>",
	{
	...
	_obj_main addAction [
	"<img image='addons\IgiLoad\images\unload_all_para.paa' /><t color=""#a50b00"">  Parachute ALL cargo</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Activer chargement</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Desactiver chargement</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Activer rampe</t>",
	{
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Desactiver rampe</t>",
	{
...
if (_obj_main_type in IL_Supported_Vehicles_HURON) then
{
	...
	"(count(nearestObjects[ _target modelToWorld [0,-7,-1], IL_Supported_Cargo_NonVeh_Huron, IL_SDistL + IL_SDistL_Heli_offset]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target == _this)) || (IL_Can_Inside && ('Turret' in (assignedVehicleRole _this)) && (vehicle _this == _target) && (_target getVariable 'can_copilot')) || ((_this in (nearestObjects[ _target modelToWorld [0,-7,-1], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside'))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load') && (((getPos _target) select 2) <= IL_LU_Alt) && (_target animationPhase 'Door_rear_source' == 1)"
	];
	_obj_main addAction [
	"<img image='addons\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Charger vehicule</t>",
	{
	...
	"(count(nearestObjects[ _target modelToWorld [0,-7,-1], IL_Supported_Cargo_Veh_Huron, IL_SDistL + IL_SDistL_Heli_offset]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target == _this)) || (IL_Can_Inside && ('Turret' in (assignedVehicleRole _this)) && (vehicle _this == _target) && (_target getVariable 'can_copilot')) || ((_this in (nearestObjects[ _target modelToWorld [0,-7,-1], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside'))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load') && (((getPos _target) select 2) <= IL_LU_Alt) && (_target animationPhase 'Door_rear_source' == 1)"
	];
	_obj_main addAction [
	"<img image='addons\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Decharger vehicule</t>",
	{
	...
	"(_target getVariable 'box_num' < 0) && ((IL_Can_Inside && (driver _target == _this)) || (IL_Can_Inside && ('Turret' in (assignedVehicleRole _this)) && (vehicle _this == _target) && (_target getVariable 'can_copilot')) || ((_this in (nearestObjects[ _target modelToWorld [0,-7,-1], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside'))) && (_target getVariable 'can_load') && (abs(speed _target) <= IL_LU_Speed) && (((getPos _target) select 2) <= IL_LU_Alt) && (_target animationPhase 'Door_rear_source' == 1)"
	];
	_obj_main addAction [
	"<img image='addons\IgiLoad\images\unload_para.paa' /><t color=""#b200ff"">  Parachute cargo</t>",
	{
	...
	"(_target getVariable 'box_num' < 0) && ((driver _target == _this) || (('Turret' in (assignedVehicleRole _this)) && (vehicle _this == _target) && (_target getVariable 'can_copilot'))) && (_target getVariable 'can_load') && (((getPosATL _target) select 2) >= IL_Para_Drop_ATL) && (_target animationPhase 'Door_rear_source' == 1)"
	];
	_obj_main addAction [
	"<img image='addons\IgiLoad\images\unload_all_para.paa' /><t color=""#a50b00"">  Parachute ALL cargo</t>",
	{
	...
	"((driver _target == _this) || (('Turret' in (assignedVehicleRole _this)) && (vehicle _this == _target) && (_target getVariable 'can_copilot')) || ((_this in (nearestObjects[ _target modelToWorld [0,-7,-1], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside'))) && (_target animationPhase 'Door_rear_source' == 0) && (_target getVariable 'can_load')"
	];
	_obj_main addAction [
	"<t color=""#0000ff"">fermer rampe</t>",
	{
	...
	"((driver _target == _this) || (('Turret' in (assignedVehicleRole _this)) && (vehicle _this == _target) && (_target getVariable 'can_copilot')) || ((_this in (nearestObjects[ _target modelToWorld [0,-7,-1], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside'))) && (_target animationPhase 'Door_rear_source' == 1) && (_target getVariable 'can_load')"
	];
	_obj_main addAction [
	"<t color=""#0000ff"">Activer chargement</t>",
	{
...
if (_obj_main_type in IL_Supported_Vehicles_MH9) then
{
	...
	_obj_main addAction [
	"<img image='addons\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load left cargo</t>",
	{
	...
	_obj_main addAction [
	"<img image='addons\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Load right cargo</t>",
	{
	...
	_obj_main addAction [
	"<img image='addons\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Unload left cargo</t>",
	{
	...
	_obj_main addAction [
	"<img image='addons\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Unload right cargo</t>",
	{
	...
	_obj_main addAction [
	"<img image='addons\IgiLoad\images\unload_para.paa' /><t color=""#b200ff"">  Parachute left cargo</t>",
	{
	...
	_obj_main addAction [
	"<img image='addons\IgiLoad\images\unload_para.paa' /><t color=""#b200ff"">  Parachute right cargo</t>",
	{
...
if (_obj_main_type in IL_Supported_Vehicles_OFFROAD) then
{
	...
	_obj_main addAction [
	"<img image='addons\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Decharger cargaison</t>",
	{
		[_this select 0] call IL_Do_Unload;
	},[],IL_Action_LU_Priority,false,true,"",
...
if (_obj_main_type in IL_Supported_Vehicles_HATCHBACK) then
{
	[_obj_main] call IL_Init_Veh;
	...
	"<img image='addons\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Charger cargaison</t>",
	{
		[_this select 0, IL_Supported_Cargo_NonVeh_Hatchback] call IL_Do_Load;
	},[],IL_Action_LU_Priority,true,true,"",
	"(count(nearestObjects[ _target modelToWorld [0,-4.5,0], IL_Supported_Cargo_NonVeh_Hatchback, IL_SDistL]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target == _this)) || ((((_this in (nearestObjects[ _target modelToWorld [0,-4.5,0], [], IL_SDistL + IL_SDistL_Heli_offset]))) && (_target getVariable 'can_outside')))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load')"
	];
	_obj_main addAction [
	"<img image='addons\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Charger vehicule</t>",
	{
		[_this select 0, IL_Supported_Cargo_Veh_Hatchback] call IL_Do_Load;
	},[],IL_Action_LU_Priority,true,true,"",
	"(count(nearestObjects[ _target modelToWorld [0,-4.5,0], IL_Supported_Cargo_Veh_Hatchback, IL_SDistL]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target == _this)) || ((((_this in (nearestObjects[ _target modelToWorld [0,-4.5,0], [], IL_SDistL + IL_SDistL_Heli_offset]))) && (_target getVariable 'can_outside')))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load')"
	];
	_obj_main addAction [
	"<img image='addons\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Decharger cargaison</t>",
	{
...
if (_obj_main_type in IL_Supported_Vehicles_STRIDER) then
{
	...
	"<img image='addons\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Charger vehicule</t>",
	{
		[_this select 0, IL_Supported_Cargo_Veh_STRIDER] call IL_Do_Load;
	},[],IL_Action_LU_Priority,true,true,"",
	"(count(nearestObjects[ _target modelToWorld [0,-4.5,0], IL_Supported_Cargo_Veh_Strider, IL_SDistL]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target == _this)) || ((((_this in (nearestObjects[ _target modelToWorld [0,-4.5,0], [], IL_SDistL + IL_SDistL_Heli_offset]))) && (_target getVariable 'can_outside')))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load')"
	];
	_obj_main addAction [
	"<img image='addons\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Decharger cargaison</t>",
	{
...
if (_obj_main_type in IL_Supported_Vehicles_TEMPEST) then
{
	...
	"(count(nearestObjects[ _target modelToWorld [0,-7.2 - (_target getVariable 'load_offset'),0], IL_Supported_Cargo_NonVeh_TEMPEST, IL_SDistL]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target == _this)) || ((((_this in (nearestObjects[ _target modelToWorld [0,-7.2 - (_target getVariable 'load_offset'),0], [], IL_SDistL + IL_SDistL_Heli_offset]))) && (_target getVariable 'can_outside')))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load')"
	];
	_obj_main addAction [
	"<img image='addons\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Charger vehicule</t>",
	{
	...
	"(count(nearestObjects[ _target modelToWorld [0,-7.2 - (_target getVariable 'load_offset'),0], IL_Supported_Cargo_Veh_TEMPEST, IL_SDistL]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target == _this)) || ((((_this in (nearestObjects[ _target modelToWorld [0,-7.2 - (_target getVariable 'load_offset'),0], [], IL_SDistL + IL_SDistL_Heli_offset]))) && (_target getVariable 'can_outside')))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load')"
	];
	_obj_main addAction [
	"<img image='addons\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Decharger vehicule</t>",
	{
...
if (_obj_main_type in IL_Supported_Vehicles_HEMTT) then
{
	...
	"(count(nearestObjects[ _target modelToWorld [0,-7.5 - (_target getVariable 'load_offset'),0], IL_Supported_Cargo_NonVeh_HEMTT, IL_SDistL]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target == _this)) || (((_this in (nearestObjects[ _target modelToWorld [0,-7.5 - (_target getVariable 'load_offset'),0], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside')))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load')"
	];
	_obj_main addAction [
	"<img image='addons\IgiLoad\images\load.paa' /><t color=""#007f0e"">  Charger vehicule</t>",
	{
	...
	"(count(nearestObjects[ _target modelToWorld [0,-7.5 - (_target getVariable 'load_offset'),0], IL_Supported_Cargo_Veh_HEMTT, IL_SDistL]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target == _this)) || (((_this in (nearestObjects[ _target modelToWorld [0,-7.5 - (_target getVariable 'load_offset'),0], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside')))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load')"
	];
	_obj_main addAction [
	"<img image='addons\IgiLoad\images\unload.paa' /><t color=""#ff0000"">  Decharger vehicule</t>",
	{
